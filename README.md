...
CLENA is Cleaning service provider and content management application, I am working this application ontinuously. My plan to convert this to a microservice application. Where i will add a apigateway and another server for real-time chating(Web socket) and video calling(WebRTC) with sellere and client.
